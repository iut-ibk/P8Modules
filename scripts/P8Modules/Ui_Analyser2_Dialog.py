...
class Ui_Analyser2_GUI(object):
	def setupUi(self, Analyser2_GUI):
		...
		self.pb_plotEBR2.setText(QtGui.QApplication.translate("Analyser2_GUI", "Stream Hydrology and Water Quality2", None, QtGui.QApplication.UnicodeUTF8))
		...
		self.pb_plotEBR3.setText(QtGui.QApplication.translate("Analyser2_GUI", "Stream Hydrology and Water Quality3", None, QtGui.QApplication.UnicodeUTF8))
		...
		self.pb_plotEBR4.setText(QtGui.QApplication.translate("Analyser2_GUI", "Stream Hydrology and Water Quality4", None, QtGui.QApplication.UnicodeUTF8))
