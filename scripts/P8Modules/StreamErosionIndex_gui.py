...
class Ui_StreamErosionIndexDialog(object):
    def setupUi(self, StreamErosionIndexguic):
        ...
        self.gridLayout.addWidget(self.le_r, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_r, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.le_r2, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_r2, 3, 2, 1, 1)

        self.header3 = QtGui.QLabel(self.groupBox)
        self.header3.setText(QtGui.QApplication.translate("StreamErosionIndexguic", "MUSIC template file", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.gridLayout.addWidget(self.le_r3, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_r3, 5, 2, 1, 1)

        self.header4 = QtGui.QLabel(self.groupBox)
        self.header4.setText(QtGui.QApplication.translate("StreamErosionIndexguic", "or User the WSC model defaults", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.city_combo.addItem(_fromUtf8(""))
        self.city_combo.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.city_combo, 7,1,1,1)
        ...
        self.gridLayout.addWidget(self.le_NoY, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.le_A, 10, 1, 1, 1)
