...
def writeMUSICcatchmentnode3(f, ID, nodepart, ncount, x, y, area, imp, parameter_list):
    ...
    f.write("------------------------------------------------------------------------------------\n")
    return True
def writeDetentionBasinNode(f,id,nodepart,x,y,parameter_list):
    f.write("Node Type,DetentionBasinNode,{Node Type}\n")
    f.write("Node Name," + str(nodepart) + ",{Node Name}\n")
    f.write("Node ID," + str(id) + ",{Node ID}\n")
    f.write("Coordinates," + str(x) + ":" + str(y) + ",{Coordinates}{X:Y}\n")
    f.write("General - Location," + str(nodepart) + ",\n")
    f.write("General - Notes,,\n")
    ...
    f.write("Advanced Properties - Permanent Pool Volume (cubic metres)," + str(parameter_list[2]) + ",{cubic metres}\n")
