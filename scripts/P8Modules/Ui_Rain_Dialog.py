...
class Ui_P8Rain_GUI(object):
    def setupUi(self, P8Rain_GUI):
        ...
        self.gridLayout.addWidget(self.pb_preview, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelcsv, 3, 0, 1, 1)
        self.le_csv = QtGui.QLineEdit(self.groupBox)
        self.le_csv.setObjectName(_fromUtf8("le_csv"))
        self.gridLayout.addWidget(self.le_csv, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_csv, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelET, 4, 0, 1, 1)
        self.le_ET = QtGui.QLineEdit(self.groupBox)
        self.le_ET.setObjectName(_fromUtf8("le_ET"))
        self.gridLayout.addWidget(self.le_ET, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pb_ET, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCoordX, 1, 0, 1, 1)
        self.le_CoordX = QtGui.QLineEdit(self.groupBox)
        self.le_CoordX.setObjectName(_fromUtf8("le_CoordX"))
        self.gridLayout.addWidget(self.le_CoordX, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelCoordY, 2, 0, 1, 1)
        self.le_CoordY = QtGui.QLineEdit(self.groupBox)
        self.le_CoordY.setObjectName(_fromUtf8("le_CoordY"))
        self.gridLayout.addWidget(self.le_CoordY, 2, 1, 1, 1)
