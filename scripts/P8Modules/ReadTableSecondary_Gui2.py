...
class ReadTableSecondary_Gui2(QtGui.QDialog):
	...
	self.ui.table.setCellWidget(2,0,QtGui.QLineEdit(str("Number of runoff days in the natural catchment (days/year)")))
	...
	f.write("Number of runoff days in the natural catchment (days/year)," + str(self.module.FreqPredev) + "\n")
