...
class ReadTableSecondary_Gui2(QtGui.QDialog):
	...
	self.ui.table.setCellWidget(3,0,QtGui.QLineEdit(str("Baseflow rate allowed in the WSUD catchement(m3/s)")))
	...
	f.write("Baseflow rate allowed in the WSUD catchement(m3/s)," + str(self.module.cin) + "\n")
