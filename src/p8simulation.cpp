...
DM_DECLARE_GROUP_NAME(P8Simulation, CRCP8)
...
void P8Simulation::run()
{
    Group::run();
}

void P8Simulation::init() {
...
bool P8Simulation::createInputDialog() {
    QWidget * w = new P8Simulation_GUI(this);
    w->show();
    return true;
}
*/
