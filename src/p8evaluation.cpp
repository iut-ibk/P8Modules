...
DM_DECLARE_GROUP_NAME(P8Evaluation, CRCP8)
...
void P8Evaluation::run()
{
    Group::run();
}

void P8Evaluation::init() {
...
bool P8Evaluation::createInputDialog() {
    QWidget * w = new P8Evaluation_GUI(this);
    w->show();
    return true;
}
*/
